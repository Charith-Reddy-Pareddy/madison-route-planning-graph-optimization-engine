...
startup to build the live app's 58-location Madison/UW-Madison network
...
to connect the 58 named locations plausibly. A separate research track
(planned, not yet in the repo) will ingest the full real OpenStreetMap
street graph for the same area instead of this curated subset.
